...
namespace reglib
{
	...
	class ModelUpdater{
        ...
        virtual void getDynamicWeights(bool isbg, Matrix4d p, RGBDFrame* frame1, double * overlaps, double * totalocclusions, RGBDFrame* frame2, cv::Mat mask, double debugg = false);
